                        ...
                        <article class="blog_item">
                            ...
                            <div class="blog_details">
                                ...
                                <a  class="d-inline-block">
                                    <h2>Detail Sewa</h2>
                                </a>                        <div class="col-xl-10 col-lg-10 col-md-10">
                            <!-- Main-menu -->
                            <div class="main-menu f-right d-none d-lg-block">
                                <nav>
                                ...
                                <!-- <div><img src="public/assets/img/bukti/{{ data.bukti }}"></div> -->
                                <img style="height: 20%; width: 20%;" src="public/assets/img/bukti/{{ data.bukti }}" alt="">
